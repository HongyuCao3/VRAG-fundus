...
res_path="./output/${dataset}/internVL2/analysis/${crop_emb}_${m}_${n}_rag_${test_num}_pics.png"
model_path="/home/hongyu/eye_llava_medllava_finetune_mistral"
cd /home/hongyu/Visual-RAG-LLaVA-Med
conda activate llava-med
python analysis_multi_turn.py \
...
res_path="./output/${dataset}/internVL2/analysis/${level_emb}_${m}_${n}_rag_${test_num}_pics.png"
model_path="/home/hongyu/eye_llava_medllava_finetune_mistral"
cd /home/hongyu/Visual-RAG-LLaVA-Med
conda activate llava-med
python analysis_multi_turn.py \
...
res_path="./output/${dataset}/internVL2/analysis/${level_emb}_${crop_emb}_${m}_${n}_rag_${test_num}_pics.png"
model_path="/home/hongyu/eye_llava_medllava_finetune_mistral"
cd /home/hongyu/Visual-RAG-LLaVA-Med
conda activate llava-med
python analysis_multi_turn.py \
