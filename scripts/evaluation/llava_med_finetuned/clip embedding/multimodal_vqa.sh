...
n=1
test_num=-1
output_path="./output/${dataset}/llava-med-finetuned/raw_${m}_${n}_rag_${test_num}.json"
log_path="./output/${dataset}/llava-med-finetuned/log/raw_${m}_${n}_rag_${test_num}.log"
